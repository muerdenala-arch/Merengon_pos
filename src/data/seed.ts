...
export const TOPPINGS: Topping[] = [
  ...
  { id: 'oreo',        name: 'Oreo triturada',        priceExtra: 4, stockByBranch: stockPerBranch(45), lowStockThreshold: 8  },
  { id: 'chispas',     name: 'Chispas de chocolate',  priceExtra: 3, stockByBranch: stockPerBranch(55), lowStockThreshold: 10 },
  { id: 'chantilly',   name: 'Chantilly extra',       priceExtra: 4, stockByBranch: stockPerBranch(35), lowStockThreshold: 8  },
  { id: 'gomitas',     name: 'Gomitas',               priceExtra: 3, stockByBranch: stockPerBranch(40), lowStockThreshold: 8  },
  { id: 'manjar',      name: 'Manjar',                priceExtra: 4, stockByBranch: stockPerBranch(30), lowStockThreshold: 6  },
  { id: 'granola',     name: 'Granola',               priceExtra: 3, stockByBranch: stockPerBranch(35), lowStockThreshold: 8  },
  { id: 'coco',        name: 'Coco rallado',          priceExtra: 3, stockByBranch: stockPerBranch(30), lowStockThreshold: 6  },
  { id: 'miel',        name: 'Miel de abeja',         priceExtra: 3, stockByBranch: stockPerBranch(25), lowStockThreshold: 5  },
];
